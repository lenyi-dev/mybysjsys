<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="org.csu.pms.domain.*"%>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="f" %>
<html>
	<head>
	<script src="http://g.tbcdn.cn/mtb/lib-flexible/0.3.4/??flexible_css.js,flexible.js"></script>
		<title>黄冈师范小区物业管理系统</title>
		<meta charset="utf-8" />
	...
	<div class="row clearfix">
		<div class="col-md-3 column" >
			<h4>
				...
				黄冈师范小区物业管理系统
			</h4><img alt="140x140" src="images/g.png" />
		...
		<div  class="col-md-8  column">
			<div  class="carousel slide" id="carousel-333416" data-ride="carousel" style="margin-left: 153px;">
				...
				<div style="height: 350px;" class="carousel-inner">
					<div style="height: 100%;width: 100%" class="item active">
						<a id="href1" href="#" target="_blank"><img id="image1" style="height: 100%;width: 100%" alt="" src="images/pic03.jpg" /></a>
						<div  class="carousel-caption">
							<h4><span id="circle_news1"></span><br></h4>
							
						</div>
					</div>
					<div  style="height: 100%;width: 100%"  class="item">
						<a id="href2" href="#" target="_blank"><img id="image2" style="height: 100%;width: 100%" alt="" src="images/pic02.jpg" /></a>
					...
					<div style="height: 100%;width: 100%" class="item">
						<a id="href3" href="#" target="_blank"><img id="image3" style="height: 100%;width: 100%" alt="" src="images/pic01.jpg" /></a>
