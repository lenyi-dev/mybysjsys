...
<body
	...
	<div class="container">
		...
		<div class="news-list">
			<div class="news-list-left">
				...
				<div class="news-list-item">
					<c:if test="${requestScope.notice.pictureAddress!=null}">
						<img src="${requestScope.notice.pictureAddress}" alt="First slide">
					</c:if>

					<br /> <br /> <br />
					<div class="author-time2">
						<!--  <span class="_">我女神</span> -->
						发表于&nbsp;&nbsp; <span class="noticeDate"> <fmt:formatDate
								value="${requestScope.notice.noticeDate}"
			...
			<footer class="copyright"> Copyright &nbsp; 2021 ZhangRui
