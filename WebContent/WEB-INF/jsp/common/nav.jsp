      ...
      <div class="modal-body">
        <form action="login" method="post" >
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="userId" id="recipient-name" value="${sessionScope.user.userId}">
          </div>
          <div class="form-group">
            <label for="message-text" class="control-label">密码:</label>
            <input type="password" class="form-control" name="password" id="recipient-name" value="${sessionScope.user.password}">
          </div>          
